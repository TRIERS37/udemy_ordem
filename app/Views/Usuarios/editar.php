    ...
    $(document).ready(function () {
        $("#form").on('submit', function (e) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (!response.erro) {
                        ...
                        if (response.info) {
                            ...
                            //tudo certo com a atualiaçao do usuário
                ...
                error: function () {
                    alert('Não foi possível processar a solicitação. Por favor entre em contato com suporte tecnico');
                    $("#btn-salvar").val('Salvar');
                    $("#btn-salvar").removeAttr("disabled");
                },
            });
